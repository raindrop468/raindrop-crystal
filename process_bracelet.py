"""Compress bracelet/necklace JPGs to WebP (main 1200px + thumb 400px)."""
from PIL import Image
import os

SRC = os.path.join(os.path.dirname(__file__), '手链')
DST = os.path.join(os.path.dirname(__file__), 'retail', 'images', 'bracelet')
os.makedirs(DST, exist_ok=True)

files = ['1.jpg', '2.jpg', '3.jpg', '4.jpg', '5.jpg', '7.jpg', '9.jpg', '11.jpg', '12.jpg']
