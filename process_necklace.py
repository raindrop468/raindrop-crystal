"""Compress necklace images to WebP format."""
from PIL import Image
from pathlib import Path

src_dir = Path(r"C:\Users\14837\Nutstore\1\2\项链")
out_dir = Path(r"C:\Users\14837\Nutstore\1\2\retail\images\necklace")
...
print("\nDone! All necklace images compressed.")
